...
const Navbar = () => {
  ...
  return (
    <div className="px-5 z-50 py-[.8rem] bg-[#A2B29F] lg:px-20 flex justify-between">
      <div className="flex items-center space-x-4">
        <div
          onClick={navigateToHome}
          className="lg:mr-10 cursor-pointer flex items-center space-x-4"
        >
          <li className="logo font-semibold text-2xl" style={{ color: '#FAEEE0' }}>
          KRAVERS
          </li>
        </div>
      ...
      <div className="flex items-center space-x-2 lg:space-x-10">
        ...
        <div className="flex items-center space-x-2">
          {auth.user?.fullName ? (
            ...
            >
              <Avatar sx={{ bgcolor: "white",color:grey.A200}} className="bg-white">
